...
require "./asset_report_transaction_type"
...
module Plaid
  ...
  class AssetReportTransaction
    ...
    @[JSON::Field(key: "transaction_type", type: Plaid::AssetReportTransactionType?, default: nil, required: false, nullable: false, emit_null: false)]
    getter transaction_type : Plaid::AssetReportTransactionType? = nil
    ...
    def initialize(
      *,
      ...
      @transaction_type : Plaid::AssetReportTransactionType? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_transaction_type = @transaction_type).nil?
        invalid_properties.push(_transaction_type.error_message) if !_transaction_type.valid?
      end
    ...
    def valid? : Bool
      ...
      unless (_transaction_type = @transaction_type).nil?
        return false if !_transaction_type.valid?
      end
    ...
    def transaction_type=(new_value : Plaid::AssetReportTransactionType?)
      unless new_value.nil?
        new_value.validate
      end
    ...
    def_equals_and_hash(@account_id, @amount, @iso_currency_code, @unofficial_currency_code, @original_description, @date, @pending, @transaction_id, @category, @category_present, @category_id, @category_id_present, @credit_category, @credit_category_present, @check_number, @check_number_present, @date_transacted, @date_transacted_present, @location, @name, @merchant_name, @merchant_name_present, @payment_meta, @pending_transaction_id, @pending_transaction_id_present, @account_owner, @account_owner_present, @transaction_type, @income_source_id)
  end
end
