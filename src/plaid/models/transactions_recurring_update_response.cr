...
module Plaid
  ...
  class TransactionsRecurringUpdateResponse
    ...
    @[JSON::Field(key: "modified_streams", type: Array(TransactionStream)?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"modified_streams\" is required and cannot be null") if @modified_streams.nil?
    ...
    def valid? : Bool
      return false if @modified_streams.nil?
      unless (_modified_streams = @modified_streams).nil?
      end
    ...
    def modified_streams=(new_value : Array(TransactionStream)?)
      raise ArgumentError.new("\"modified_streams\" is required and cannot be null") if new_value.nil?
    ...
    def_equals_and_hash(@modified_streams, @removed_stream_ids)
  end
end
