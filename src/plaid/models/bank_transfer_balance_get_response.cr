...
module Plaid
  ...
  class BankTransferBalanceGetResponse
    ...
    @[JSON::Field(key: "balance", type: BankTransferBalance?, default: nil, required: true, nullable: false, emit_null: false)]
    getter balance : BankTransferBalance? = nil
    ...
    def initialize(
      *,
      # Required properties
      @balance : BankTransferBalance? = nil,
    ...
    def balance=(new_value : BankTransferBalance?)
    ...
    def_equals_and_hash(@balance, @origination_account_id, @request_id)
  end
end
