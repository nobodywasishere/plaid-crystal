...
module Plaid
  ...
  class CreditSessionsGetResponse
    ...
    @[JSON::Field(key: "sessions", type: Array(Plaid::CreditSession)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter sessions : Array(Plaid::CreditSession)? = nil
    ...
    def initialize(
      *,
      ...
      # Optional properties
      @sessions : Array(Plaid::CreditSession)? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_sessions = @sessions).nil?
        invalid_properties.concat(OpenApi::ContainerValidator.list_invalid_properties_for(key: "sessions", container: _sessions)) if _sessions.is_a?(Array)
      end
      invalid_properties
    end
    ...
    def valid? : Bool
      ...
      unless (_sessions = @sessions).nil?
        return false if _sessions.is_a?(Array) && !OpenApi::ContainerValidator.valid?(container: _sessions)
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] sessions Object to be assigned
    def sessions=(new_value : Array(Plaid::CreditSession)?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@request_id, @sessions)
  end
end
