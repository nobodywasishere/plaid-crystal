...
module Plaid
  ...
  class BankTransferSweepListRequest
    ...
    def_equals_and_hash(@client_id, @secret, @origination_account_id, @origination_account_id_present, @start_time, @start_time_present, @end_time, @end_time_present, @count, @count_present)
  end
end
