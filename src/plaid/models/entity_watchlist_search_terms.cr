...
module Plaid
  ...
  class EntityWatchlistSearchTerms
    ...
    @[JSON::Field(key: "document_number", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: document_number.nil? && !document_number_present?)]
    getter document_number : String? = nil
    MIN_LENGTH_FOR_DOCUMENT_NUMBER = 4

    @[JSON::Field(ignore: true)]
    property? document_number_present : Bool = false
    ...
    def_equals_and_hash(@entity_watchlist_program_id, @legal_name, @document_number, @document_number_present, @email_address, @email_address_present, @country, @country_present, @phone_number, @phone_number_present, @url, @url_present)
  end
end
