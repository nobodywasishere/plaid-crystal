...
require "./watchlist_screening_request_search_terms"
...
module Plaid
  ...
  class WatchlistScreeningIndividualCreateRequest
    ...
    @[JSON::Field(key: "search_terms", type: Plaid::WatchlistScreeningRequestSearchTerms?, default: nil, required: true, nullable: false, emit_null: false)]
    getter search_terms : Plaid::WatchlistScreeningRequestSearchTerms? = nil
    ...
    def initialize(
      *,
      # Required properties
      @search_terms : Plaid::WatchlistScreeningRequestSearchTerms? = nil,
      # Optional properties
    ...
    def search_terms=(new_value : Plaid::WatchlistScreeningRequestSearchTerms?)
