...
module Plaid
  ...
  class InvestmentTransaction
    ...
    @[JSON::Field(key: "cancel_transaction_id", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: cancel_transaction_id.nil? && !cancel_transaction_id_present?)]
    getter cancel_transaction_id : String? = nil

    @[JSON::Field(ignore: true)]
    property? cancel_transaction_id_present : Bool = false
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_cancel_transaction_id = @cancel_transaction_id).nil?
      end
      invalid_properties
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] cancel_transaction_id Object to be assigned
    def cancel_transaction_id=(new_value : String?)
      unless new_value.nil?
      end

      @cancel_transaction_id = new_value
    end
    ...
    def_equals_and_hash(@investment_transaction_id, @account_id, @security_id, @date, @name, @quantity, @amount, @price, @fees, @_type, @subtype, @iso_currency_code, @unofficial_currency_code, @cancel_transaction_id, @cancel_transaction_id_present)
  end
end
