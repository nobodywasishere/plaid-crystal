...
require "./investments_transactions_get_request_options"
...
module Plaid
  ...
  class InvestmentsTransactionsGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::InvestmentsTransactionsGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::InvestmentsTransactionsGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::InvestmentsTransactionsGetRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::InvestmentsTransactionsGetRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@access_token, @start_date, @end_date, @client_id, @secret, @options)
  end
end
