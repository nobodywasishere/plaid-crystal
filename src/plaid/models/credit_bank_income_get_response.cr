...
module Plaid
  ...
  class CreditBankIncomeGetResponse
    ...
    @[JSON::Field(key: "bank_income", type: Array(Plaid::CreditBankIncome)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter bank_income : Array(Plaid::CreditBankIncome)? = nil
    ...
    def initialize(
      *,
      ...
      # Optional properties
      @bank_income : Array(Plaid::CreditBankIncome)? = nil
    )
    end
    ...
    def bank_income=(new_value : Array(Plaid::CreditBankIncome)?)
      unless new_value.nil?
