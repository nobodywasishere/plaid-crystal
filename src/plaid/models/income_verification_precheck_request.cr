...
require "./income_verification_precheck_user"
...
module Plaid
  ...
  class IncomeVerificationPrecheckRequest
    ...
    @[JSON::Field(key: "user", type: Plaid::IncomeVerificationPrecheckUser?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: user.nil? && !user_present?)]
    getter user : Plaid::IncomeVerificationPrecheckUser? = nil
    ...
    @[JSON::Field(key: "transactions_access_token", type: String?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: transactions_access_token.nil? && !transactions_access_token_present?)]
    getter transactions_access_token : String? = nil

    @[JSON::Field(ignore: true)]
    property? transactions_access_token_present : Bool = false
    ...
    @[JSON::Field(key: "transactions_access_tokens", type: Array(String)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter transactions_access_tokens : Array(String)? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @user : Plaid::IncomeVerificationPrecheckUser? = nil,
      ...
      @transactions_access_token : String? = nil,
      @transactions_access_tokens : Array(String)? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_transactions_access_token = @transactions_access_token).nil?
      end
      unless (_transactions_access_tokens = @transactions_access_tokens).nil?
      end
    ...
    def user=(new_value : Plaid::IncomeVerificationPrecheckUser?)
      unless new_value.nil?
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] transactions_access_token Object to be assigned
    def transactions_access_token=(new_value : String?)
      unless new_value.nil?
      end

      @transactions_access_token = new_value
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] transactions_access_tokens Object to be assigned
    def transactions_access_tokens=(new_value : Array(String)?)
      unless new_value.nil?
      end

      @transactions_access_tokens = new_value
    end
    ...
    def_equals_and_hash(@client_id, @secret, @user, @user_present, @employer, @employer_present, @payroll_institution, @payroll_institution_present, @transactions_access_token, @transactions_access_token_present, @transactions_access_tokens, @us_military_info, @us_military_info_present)
  end
end
