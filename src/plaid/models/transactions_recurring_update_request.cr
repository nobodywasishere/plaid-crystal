...
module Plaid
  ...
  class TransactionsRecurringUpdateRequest
    ...
    @[JSON::Field(key: "inputs", type: Array(Plaid::TransactionsRecurringUpdateInput)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter inputs : Array(Plaid::TransactionsRecurringUpdateInput)? = nil
    ...
    def initialize(
      *,
      ...
      @inputs : Array(Plaid::TransactionsRecurringUpdateInput)? = nil,
      # Optional properties
    ...
    def inputs=(new_value : Array(Plaid::TransactionsRecurringUpdateInput)?)
