...
require "./cra_bank_income_item"
require "./cra_bank_income_summary"
require "./cra_bank_income_warning"
...
module Plaid
  ...
  class CraBankIncome
    ...
    @[JSON::Field(key: "items", type: Array(Plaid::CraBankIncomeItem)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter items : Array(Plaid::CraBankIncomeItem)? = nil

    @[JSON::Field(key: "bank_income_summary", type: CraBankIncomeSummary?, default: nil, required: false, nullable: false, emit_null: false)]
    getter bank_income_summary : CraBankIncomeSummary? = nil
    ...
    @[JSON::Field(key: "warnings", type: Array(Plaid::CraBankIncomeWarning)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter warnings : Array(Plaid::CraBankIncomeWarning)? = nil
    ...
    def items=(new_value : Array(Plaid::CraBankIncomeItem)?)
      unless new_value.nil?
    ...
    def bank_income_summary=(new_value : CraBankIncomeSummary?)
      unless new_value.nil?
      end
    ...
    def warnings=(new_value : Array(Plaid::CraBankIncomeWarning)?)
      unless new_value.nil?
        OpenApi::ContainerValidator.validate(container: new_value) if new_value.is_a?(Array)
      end
