...
module Plaid
  ...
  class DashboardUserListResponse
    ...
    @[JSON::Field(key: "dashboard_users", type: Array(DashboardUser)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter dashboard_users : Array(DashboardUser)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @dashboard_users : Array(DashboardUser)? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"dashboard_users\" is required and cannot be null") if @dashboard_users.nil?

      unless (_dashboard_users = @dashboard_users).nil?
      end
    ...
    def valid? : Bool
      return false if @dashboard_users.nil?
      unless (_dashboard_users = @dashboard_users).nil?
      end
    ...
    # @param [Object] dashboard_users Object to be assigned
    def dashboard_users=(new_value : Array(DashboardUser)?)
      raise ArgumentError.new("\"dashboard_users\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @dashboard_users = new_value
    end
    ...
    def_equals_and_hash(@dashboard_users, @next_cursor, @request_id)
  end
end
