...
require "./reporting_information"
require "./service_product_fulfillment"
require "./verification_of_asset_response"
...
module Plaid
  ...
  class VerificationOfAsset
    ...
    @[JSON::Field(key: "REPORTING_INFORMATION", type: ReportingInformation?, default: nil, required: true, nullable: false, emit_null: false)]
    getter reporting_information : ReportingInformation? = nil
    ...
    @[JSON::Field(key: "VERIFICATION_OF_ASSET_RESPONSE", type: VerificationOfAssetResponse?, default: nil, required: true, nullable: false, emit_null: false)]
    getter verification_of_asset_response : VerificationOfAssetResponse? = nil
    ...
    def initialize(
      *,
      # Required properties
      @reporting_information : ReportingInformation? = nil,
      @service_product_fulfillment : ServiceProductFulfillment? = nil,
      @verification_of_asset_response : VerificationOfAssetResponse? = nil
    )
    end
    ...
    def reporting_information=(new_value : ReportingInformation?)
    ...
    def verification_of_asset_response=(new_value : VerificationOfAssetResponse?)
