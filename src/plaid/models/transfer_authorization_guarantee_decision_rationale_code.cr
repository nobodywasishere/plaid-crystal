...
module Plaid
  class TransferAuthorizationGuaranteeDecisionRationaleCode
    ...
    def self.from_json(value : JSON::PullParser) : TransferAuthorizationGuaranteeDecisionRationaleCode
      new(value)
    end

    def self.to_json(value : TransferAuthorizationGuaranteeDecisionRationaleCode, json : JSON::Builder) : Nil
      value.to_json(json)
    end
    ...
    def validate : Nil
      OpenApi::EnumValidator.validate("TransferAuthorizationGuaranteeDecisionRationaleCode", data, VALID_VALUES, false)
    end
