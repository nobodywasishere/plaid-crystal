...
module Plaid
  ...
  class TransactionsRulesRemoveRequest
    ...
    @[JSON::Field(key: "rule_id", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"rule_id\" is required and cannot be null") if @rule_id.nil?

      unless (_rule_id = @rule_id).nil?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] rule_id Object to be assigned
    def rule_id=(new_value : String?)
      raise ArgumentError.new("\"rule_id\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end
    ...
    def_equals_and_hash(@access_token, @rule_id, @client_id, @secret)
  end
end
