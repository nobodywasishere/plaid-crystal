...
require "./watchlist_screening_hit_locations"
...
module Plaid
  ...
  class GenericScreeningHitLocationItems
    ...
    @[JSON::Field(key: "data", type: WatchlistScreeningHitLocations?, default: nil, required: false, nullable: false, emit_null: false)]
    getter data : WatchlistScreeningHitLocations? = nil
    ...
    def initialize(
      *,
      ...
      @data : WatchlistScreeningHitLocations? = nil
    )
    end
    ...
    def data=(new_value : WatchlistScreeningHitLocations?)
      unless new_value.nil?
      end
