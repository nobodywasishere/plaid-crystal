...
module Plaid
  ...
  class BankTransferGetResponse
    ...
    @[JSON::Field(key: "bank_transfer", type: BankTransfer?, default: nil, required: true, nullable: false, emit_null: false)]
    getter bank_transfer : BankTransfer? = nil
    ...
    def initialize(
      *,
      # Required properties
      @bank_transfer : BankTransfer? = nil,
    ...
    def bank_transfer=(new_value : BankTransfer?)
    ...
    def_equals_and_hash(@bank_transfer, @request_id)
  end
end
