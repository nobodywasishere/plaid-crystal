...
require "./earnings_breakdown_canonical_description"
...
module Plaid
  ...
  class EarningsBreakdown
    ...
    @[JSON::Field(key: "canonical_description", type: Plaid::EarningsBreakdownCanonicalDescription?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: canonical_description.nil? && !canonical_description_present?)]
    getter canonical_description : Plaid::EarningsBreakdownCanonicalDescription? = nil
    ...
    @[JSON::Field(key: "rate", type: Float64?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: rate.nil? && !rate_present?)]
    getter rate : Float64? = nil

    @[JSON::Field(ignore: true)]
    property? rate_present : Bool = false
    ...
    def initialize(
      *,
      # Optional properties
      @canonical_description : Plaid::EarningsBreakdownCanonicalDescription? = nil,
    ...
    def canonical_description=(new_value : Plaid::EarningsBreakdownCanonicalDescription?)
    ...
    def_equals_and_hash(@canonical_description, @canonical_description_present, @current_amount, @current_amount_present, @description, @description_present, @hours, @hours_present, @iso_currency_code, @iso_currency_code_present, @rate, @rate_present, @unofficial_currency_code, @unofficial_currency_code_present, @ytd_amount, @ytd_amount_present)
  end
end
