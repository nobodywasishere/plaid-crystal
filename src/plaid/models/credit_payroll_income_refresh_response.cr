...
module Plaid
  ...
  class CreditPayrollIncomeRefreshResponse
    ...
    @[JSON::Field(key: "verification_refresh_status", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    getter verification_refresh_status : String? = nil
    ...
    def initialize(
      *,
      ...
      @verification_refresh_status : String? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"verification_refresh_status\" is required and cannot be null") if @verification_refresh_status.nil?

      unless (_verification_refresh_status = @verification_refresh_status).nil?
      end
      invalid_properties
    end
    ...
    def valid? : Bool
      ...
      return false if @verification_refresh_status.nil?
      unless (_verification_refresh_status = @verification_refresh_status).nil?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] verification_refresh_status Object to be assigned
    def verification_refresh_status=(new_value : String?)
      raise ArgumentError.new("\"verification_refresh_status\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @verification_refresh_status = new_value
    end
    ...
    def_equals_and_hash(@request_id, @verification_refresh_status)
  end
end
