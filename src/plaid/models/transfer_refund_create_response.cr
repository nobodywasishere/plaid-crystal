...
module Plaid
  ...
  class TransferRefundCreateResponse
    ...
    @[JSON::Field(key: "refund", type: TransferRefund?, default: nil, required: true, nullable: false, emit_null: false)]
    getter refund : TransferRefund? = nil
    ...
    def refund=(new_value : TransferRefund?)
    ...
    def_equals_and_hash(@refund, @request_id)
  end
end
