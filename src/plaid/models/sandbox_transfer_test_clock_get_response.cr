...
module Plaid
  ...
  class SandboxTransferTestClockGetResponse
    ...
    @[JSON::Field(key: "test_clock", type: TransferTestClock?, default: nil, required: true, nullable: false, emit_null: false)]
    getter test_clock : TransferTestClock? = nil
    ...
    def initialize(
      *,
      # Required properties
      @test_clock : TransferTestClock? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"test_clock\" is required and cannot be null") if @test_clock.nil?
    ...
    def valid? : Bool
      return false if @test_clock.nil?
      unless (_test_clock = @test_clock).nil?
      end
    ...
    def test_clock=(new_value : TransferTestClock?)
      raise ArgumentError.new("\"test_clock\" is required and cannot be null") if new_value.nil?
    ...
    def_equals_and_hash(@test_clock, @request_id)
  end
end
