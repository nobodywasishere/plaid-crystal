...
require "./credit_payroll_income_refresh_request_options"
...
module Plaid
  ...
  class CreditPayrollIncomeRefreshRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::CreditPayrollIncomeRefreshRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::CreditPayrollIncomeRefreshRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::CreditPayrollIncomeRefreshRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::CreditPayrollIncomeRefreshRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@user_token, @client_id, @secret, @options)
  end
end
