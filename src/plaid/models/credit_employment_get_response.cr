...
require "./credit_employment_item"
...
module Plaid
  ...
  class CreditEmploymentGetResponse
    ...
    @[JSON::Field(key: "items", type: Array(CreditEmploymentItem)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter items : Array(CreditEmploymentItem)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @items : Array(CreditEmploymentItem)? = nil,
    ...
    def items=(new_value : Array(CreditEmploymentItem)?)
