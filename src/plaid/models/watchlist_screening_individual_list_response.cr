...
require "./watchlist_screening_individual"
...
module Plaid
  ...
  class WatchlistScreeningIndividualListResponse
    ...
    @[JSON::Field(key: "watchlist_screenings", type: Array(WatchlistScreeningIndividual)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter watchlist_screenings : Array(WatchlistScreeningIndividual)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @watchlist_screenings : Array(WatchlistScreeningIndividual)? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"watchlist_screenings\" is required and cannot be null") if @watchlist_screenings.nil?

      unless (_watchlist_screenings = @watchlist_screenings).nil?
      end
    ...
    def valid? : Bool
      return false if @watchlist_screenings.nil?
      unless (_watchlist_screenings = @watchlist_screenings).nil?
      end
    ...
    # @param [Object] watchlist_screenings Object to be assigned
    def watchlist_screenings=(new_value : Array(WatchlistScreeningIndividual)?)
      raise ArgumentError.new("\"watchlist_screenings\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @watchlist_screenings = new_value
    end
    ...
    def_equals_and_hash(@watchlist_screenings, @next_cursor, @request_id)
  end
end
