...
require "./individual_screening_hit_names"
...
module Plaid
  ...
  class ScreeningHitNamesItems
    ...
    @[JSON::Field(key: "data", type: IndividualScreeningHitNames?, default: nil, required: false, nullable: false, emit_null: false)]
    getter data : IndividualScreeningHitNames? = nil
    ...
    def initialize(
      *,
      ...
      @data : IndividualScreeningHitNames? = nil
    )
    end
    ...
    def data=(new_value : IndividualScreeningHitNames?)
      unless new_value.nil?
      end
