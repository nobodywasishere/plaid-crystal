...
require "./asset_report_get_request_options"
...
module Plaid
  ...
  class AssetReportGetRequest
    ...
    @[JSON::Field(key: "asset_report_token", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "include_insights", type: Bool?, default: false, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "fast_report", type: Bool?, default: false, required: false, nullable: false, emit_null: false)]
    getter fast_report : Bool? = false

    @[JSON::Field(key: "options", type: Plaid::AssetReportGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::AssetReportGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @options : Plaid::AssetReportGetRequestOptions? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_include_insights = @include_insights).nil?
      end
      unless (_fast_report = @fast_report).nil?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] include_insights Object to be assigned
    def include_insights=(new_value : Bool?)
      unless new_value.nil?
      end

      @include_insights = new_value
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] fast_report Object to be assigned
    def fast_report=(new_value : Bool?)
      unless new_value.nil?
      end

      @fast_report = new_value
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] options Object to be assigned
    def options=(new_value : Plaid::AssetReportGetRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@client_id, @secret, @asset_report_token, @user_token, @include_insights, @fast_report, @options)
  end
end
