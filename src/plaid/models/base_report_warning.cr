...
require "./base_report_warning_code"
require "./cause"
...
module Plaid
  ...
  class BaseReportWarning
    ...
    @[JSON::Field(key: "warning_code", type: Plaid::BaseReportWarningCode?, default: nil, required: true, nullable: false, emit_null: false)]
    getter warning_code : Plaid::BaseReportWarningCode? = nil
    ...
    def initialize(
      *,
      ...
      @warning_code : Plaid::BaseReportWarningCode? = nil,
    ...
    def warning_code=(new_value : Plaid::BaseReportWarningCode?)
