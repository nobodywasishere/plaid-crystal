...
require "./cra_bank_income_complete_result"
...
module Plaid
  ...
  class CraBankIncomeCompleteWebhook
    ...
    @[JSON::Field(key: "result", type: Plaid::CraBankIncomeCompleteResult?, default: nil, required: true, nullable: false, emit_null: false)]
    getter result : Plaid::CraBankIncomeCompleteResult? = nil
    ...
    def initialize(
      *,
      ...
      @user_id : String? = nil,
      @result : Plaid::CraBankIncomeCompleteResult? = nil,
    ...
    def result=(new_value : Plaid::CraBankIncomeCompleteResult?)
