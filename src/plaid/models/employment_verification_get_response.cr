...
require "./employment_verification"
...
module Plaid
  ...
  class EmploymentVerificationGetResponse
    ...
    @[JSON::Field(key: "employments", type: Array(EmploymentVerification)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter employments : Array(EmploymentVerification)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @employments : Array(EmploymentVerification)? = nil,
    ...
    def employments=(new_value : Array(EmploymentVerification)?)
    ...
    def_equals_and_hash(@employments, @request_id)
  end
end
