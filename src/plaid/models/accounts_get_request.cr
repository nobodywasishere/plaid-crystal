...
require "./accounts_get_request_options"
...
module Plaid
  ...
  class AccountsGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::AccountsGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::AccountsGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::AccountsGetRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::AccountsGetRequestOptions?)
      unless new_value.nil?
