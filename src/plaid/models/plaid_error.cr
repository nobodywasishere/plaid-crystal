...
module Plaid
  ...
  class PlaidError
    ...
    def_equals_and_hash(@error_type, @error_code, @error_message, @display_message, @request_id, @causes, @status, @status_present, @documentation_url, @suggested_action, @suggested_action_present)
  end
end
