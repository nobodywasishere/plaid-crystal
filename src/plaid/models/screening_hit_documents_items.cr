...
require "./watchlist_screening_document"
...
module Plaid
  ...
  class ScreeningHitDocumentsItems
    ...
    @[JSON::Field(key: "data", type: WatchlistScreeningDocument?, default: nil, required: false, nullable: false, emit_null: false)]
    getter data : WatchlistScreeningDocument? = nil
    ...
    def initialize(
      *,
      ...
      @data : WatchlistScreeningDocument? = nil
    )
    end
    ...
    def data=(new_value : WatchlistScreeningDocument?)
      unless new_value.nil?
      end
