...
module Plaid
  ...
  class LinkDeliveryCreateRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::LinkDeliveryOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::LinkDeliveryOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::LinkDeliveryOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::LinkDeliveryOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@link_token, @client_id, @secret, @options)
  end
end
