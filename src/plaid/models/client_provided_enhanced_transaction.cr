...
module Plaid
  ...
  class ClientProvidedEnhancedTransaction
    ...
    @[JSON::Field(key: "enhancements", type: Enhancements?, default: nil, required: true, nullable: false, emit_null: false)]
    getter enhancements : Enhancements? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"enhancements\" is required and cannot be null") if @enhancements.nil?

      unless (_enhancements = @enhancements).nil?
      end
      invalid_properties
    end
    ...
    def valid? : Bool
      ...
      return false if @enhancements.nil?
      unless (_enhancements = @enhancements).nil?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] enhancements Object to be assigned
    def enhancements=(new_value : Enhancements?)
      raise ArgumentError.new("\"enhancements\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @enhancements = new_value
    end
    ...
    def_equals_and_hash(@id, @description, @amount, @iso_currency_code, @enhancements)
  end
end
