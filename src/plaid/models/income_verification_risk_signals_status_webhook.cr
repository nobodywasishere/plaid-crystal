...
module Plaid
  ...
  class IncomeVerificationRiskSignalsStatusWebhook
    ...
    @[JSON::Field(key: "risk_signals_status", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter risk_signals_status : String? = nil
    ...
    def initialize(
      *,
      ...
      # Optional properties
      @user_id : String? = nil,
      @risk_signals_status : String? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_risk_signals_status = @risk_signals_status).nil?
      end
      invalid_properties
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] risk_signals_status Object to be assigned
    def risk_signals_status=(new_value : String?)
      unless new_value.nil?
      end

      @risk_signals_status = new_value
    end
    ...
    def_equals_and_hash(@webhook_type, @webhook_code, @item_id, @environment, @user_id, @risk_signals_status)
  end
end
