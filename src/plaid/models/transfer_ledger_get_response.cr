...
require "./transfer_ledger_balance"
...
module Plaid
  ...
  class TransferLedgerGetResponse
    ...
    @[JSON::Field(key: "balance", type: TransferLedgerBalance?, default: nil, required: true, nullable: false, emit_null: false)]
    getter balance : TransferLedgerBalance? = nil
    ...
    def initialize(
      *,
      # Required properties
      @balance : TransferLedgerBalance? = nil,
    ...
    def balance=(new_value : TransferLedgerBalance?)
