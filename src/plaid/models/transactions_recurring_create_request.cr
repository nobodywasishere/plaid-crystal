...
module Plaid
  ...
  class TransactionsRecurringCreateRequest
    ...
    @[JSON::Field(key: "inputs", type: Array(Plaid::TransactionsRecurringCreateInput)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter inputs : Array(Plaid::TransactionsRecurringCreateInput)? = nil
    ...
    def initialize(
      *,
      ...
      @inputs : Array(Plaid::TransactionsRecurringCreateInput)? = nil,
      # Optional properties
    ...
    def inputs=(new_value : Array(Plaid::TransactionsRecurringCreateInput)?)
