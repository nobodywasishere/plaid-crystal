...
module Plaid
  ...
  class WalletTransactionGetRequest
    ...
    MIN_LENGTH_FOR_TRANSACTION_ID = 1
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_transaction_id = @transaction_id).nil?
        if min_length_error = OpenApi::PrimitiveValidator.min_length_error("transaction_id", _transaction_id.to_s.size, MIN_LENGTH_FOR_TRANSACTION_ID)
    ...
    def valid? : Bool
      ...
      unless (_transaction_id = @transaction_id).nil?
        return false if _transaction_id.to_s.size < MIN_LENGTH_FOR_TRANSACTION_ID
      end
    ...
    def transaction_id=(new_value : String?)
      ...
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_min_length("transaction_id", new_value.to_s.size, MIN_LENGTH_FOR_TRANSACTION_ID)
      end
    ...
    def_equals_and_hash(@transaction_id, @client_id, @secret)
  end
end
