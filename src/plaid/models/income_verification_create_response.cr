...
module Plaid
  ...
  class IncomeVerificationCreateResponse
    ...
    @[JSON::Field(key: "income_verification_id", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"income_verification_id\" is required and cannot be null") if @income_verification_id.nil?
    ...
    def valid? : Bool
      return false if @income_verification_id.nil?
      unless (_income_verification_id = @income_verification_id).nil?
      end
    ...
    def income_verification_id=(new_value : String?)
      raise ArgumentError.new("\"income_verification_id\" is required and cannot be null") if new_value.nil?
    ...
    def_equals_and_hash(@income_verification_id, @request_id)
  end
end
