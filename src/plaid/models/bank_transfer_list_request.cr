...
module Plaid
  ...
  class BankTransferListRequest
    ...
    @[JSON::Field(key: "direction", type: Plaid::BankTransferDirection?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: direction.nil? && !direction_present?)]
    ...
    def_equals_and_hash(@client_id, @secret, @start_date, @start_date_present, @end_date, @end_date_present, @count, @offset, @origination_account_id, @origination_account_id_present, @direction, @direction_present)
  end
end
