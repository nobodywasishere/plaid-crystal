...
module Plaid
  ...
  class BankTransferSweepGetResponse
    ...
    @[JSON::Field(key: "sweep", type: BankTransferSweep?, default: nil, required: true, nullable: false, emit_null: false)]
    getter sweep : BankTransferSweep? = nil
    ...
    def sweep=(new_value : BankTransferSweep?)
