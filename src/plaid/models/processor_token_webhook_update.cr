...
module Plaid
  ...
  class ProcessorTokenWebhookUpdate
    ...
    # The new webhook URL.
    @[JSON::Field(key: "new_webhook_url", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    getter new_webhook_url : String? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"new_webhook_url\" is required and cannot be null") if @new_webhook_url.nil?

      unless (_new_webhook_url = @new_webhook_url).nil?
      end
    ...
    def valid? : Bool
      ...
      return false if @new_webhook_url.nil?
      unless (_new_webhook_url = @new_webhook_url).nil?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] new_webhook_url Object to be assigned
    def new_webhook_url=(new_value : String?)
      raise ArgumentError.new("\"new_webhook_url\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @new_webhook_url = new_value
    end
    ...
    def_equals_and_hash(@webhook_type, @webhook_code, @account_id, @new_webhook_url, @environment, @error, @error_present)
  end
end
