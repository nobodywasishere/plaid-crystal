...
module Plaid
  ...
  class PayFrequency
    ...
    @[JSON::Field(key: "value", type: Plaid::PayFrequencyValue?, default: nil, required: true, nullable: false, emit_null: false)]
    getter value : Plaid::PayFrequencyValue? = nil
    ...
    def initialize(
      *,
      # Required properties
      @value : Plaid::PayFrequencyValue? = nil,
    ...
    def value=(new_value : Plaid::PayFrequencyValue?)
