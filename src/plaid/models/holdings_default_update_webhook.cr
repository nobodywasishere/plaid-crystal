...
module Plaid
  ...
  class HoldingsDefaultUpdateWebhook
    ...
    @[JSON::Field(key: "new_holdings", type: Float64?, default: nil, required: true, nullable: false, emit_null: false)]
    getter new_holdings : Float64? = nil

    # The number of updated holdings reported since the last time this webhook was fired.
    @[JSON::Field(key: "updated_holdings", type: Float64?, default: nil, required: true, nullable: false, emit_null: false)]
    getter updated_holdings : Float64? = nil
    ...
    def initialize(
      *,
      ...
      @item_id : String? = nil,
      @new_holdings : Float64? = nil,
      @updated_holdings : Float64? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"new_holdings\" is required and cannot be null") if @new_holdings.nil?

      unless (_new_holdings = @new_holdings).nil?
      end
      invalid_properties.push("\"updated_holdings\" is required and cannot be null") if @updated_holdings.nil?

      unless (_updated_holdings = @updated_holdings).nil?
      end
    ...
    def valid? : Bool
      ...
      return false if @new_holdings.nil?
      unless (_new_holdings = @new_holdings).nil?
      end

      return false if @updated_holdings.nil?
      unless (_updated_holdings = @updated_holdings).nil?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] new_holdings Object to be assigned
    def new_holdings=(new_value : Float64?)
      raise ArgumentError.new("\"new_holdings\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @new_holdings = new_value
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] updated_holdings Object to be assigned
    def updated_holdings=(new_value : Float64?)
      raise ArgumentError.new("\"updated_holdings\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @updated_holdings = new_value
    end
    ...
    def_equals_and_hash(@webhook_type, @webhook_code, @item_id, @new_holdings, @updated_holdings, @environment, @error, @error_present)
  end
end
