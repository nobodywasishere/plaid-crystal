...
module Plaid
  class TotalCanonicalDescription
    ...
    def self.from_json(value : JSON::PullParser) : TotalCanonicalDescription
      new(value)
    end

    def self.to_json(value : TotalCanonicalDescription, json : JSON::Builder) : Nil
      value.to_json(json)
    end
    ...
    def validate : Nil
      OpenApi::EnumValidator.validate("TotalCanonicalDescription", data, VALID_VALUES, false)
    end
