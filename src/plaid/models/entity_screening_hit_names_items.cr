...
require "./entity_screening_hit_names"
...
module Plaid
  ...
  class EntityScreeningHitNamesItems
    ...
    @[JSON::Field(key: "data", type: EntityScreeningHitNames?, default: nil, required: false, nullable: false, emit_null: false)]
    getter data : EntityScreeningHitNames? = nil
    ...
    def initialize(
      *,
      ...
      @data : EntityScreeningHitNames? = nil
    )
    end
    ...
    def data=(new_value : EntityScreeningHitNames?)
      unless new_value.nil?
      end
