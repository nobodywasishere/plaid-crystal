...
require "./entity_screening_hit_emails"
...
module Plaid
  ...
  class EntityScreeningHitEmailsItems
    ...
    @[JSON::Field(key: "data", type: EntityScreeningHitEmails?, default: nil, required: false, nullable: false, emit_null: false)]
    getter data : EntityScreeningHitEmails? = nil
    ...
    def initialize(
      *,
      ...
      @data : EntityScreeningHitEmails? = nil
    )
    end
    ...
    def data=(new_value : EntityScreeningHitEmails?)
      unless new_value.nil?
      end
