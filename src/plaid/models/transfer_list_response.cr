...
module Plaid
  ...
  class TransferListResponse
    ...
    @[JSON::Field(key: "transfers", type: Array(Transfer)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter transfers : Array(Transfer)? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"transfers\" is required and cannot be null") if @transfers.nil?
    ...
    def transfers=(new_value : Array(Transfer)?)
      raise ArgumentError.new("\"transfers\" is required and cannot be null") if new_value.nil?
    ...
    def_equals_and_hash(@transfers, @request_id)
  end
end
