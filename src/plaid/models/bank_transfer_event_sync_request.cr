...
module Plaid
  ...
  class BankTransferEventSyncRequest
    ...
    @[JSON::Field(key: "after_id", type: Int32?, default: nil, required: true, nullable: false, emit_null: false)]
    getter after_id : Int32? = nil
    MIN_FOR_AFTER_ID = Int32.new("0")
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"after_id\" is required and cannot be null") if @after_id.nil?

      unless (_after_id = @after_id).nil?
        if min_number_error = OpenApi::PrimitiveValidator.min_number_error("after_id", _after_id, MIN_FOR_AFTER_ID)
    ...
    def valid? : Bool
      ...
      unless (_after_id = @after_id).nil?
        return false if _after_id < MIN_FOR_AFTER_ID
      end
    ...
    # @param [Object] after_id Object to be assigned
    def after_id=(new_value : Int32?)
      raise ArgumentError.new("\"after_id\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_min_number("after_id", new_value, MIN_FOR_AFTER_ID)
      end
    ...
    def_equals_and_hash(@after_id, @client_id, @secret, @count, @count_present)
  end
end
