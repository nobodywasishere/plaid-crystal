...
module Plaid
  ...
  class AssetReportAuditCopyCreateRequest
    ...
    @[JSON::Field(key: "auditor_id", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter auditor_id : String? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_auditor_id = @auditor_id).nil?
      end
      invalid_properties
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] auditor_id Object to be assigned
    def auditor_id=(new_value : String?)
      unless new_value.nil?
      end

      @auditor_id = new_value
    end
    ...
    def_equals_and_hash(@asset_report_token, @client_id, @secret, @auditor_id)
  end
end
