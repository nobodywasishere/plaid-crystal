...
require "./credit_freddie_mac_party_individual"
require "./roles"
...
module Plaid
  ...
  class CreditFreddieMacParty
    ...
    @[JSON::Field(key: "INDIVIDUAL", type: CreditFreddieMacPartyIndividual?, default: nil, required: true, nullable: false, emit_null: false)]
    getter individual : CreditFreddieMacPartyIndividual? = nil
    ...
    def initialize(
      *,
      # Required properties
      @individual : CreditFreddieMacPartyIndividual? = nil,
      @roles : Roles? = nil,
    ...
    def individual=(new_value : CreditFreddieMacPartyIndividual?)
