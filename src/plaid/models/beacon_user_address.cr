...
module Plaid
  ...
  class BeaconUserAddress
    ...
    @[JSON::Field(key: "street2", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def_equals_and_hash(@street, @street2, @city, @region, @postal_code, @country)
  end
end
