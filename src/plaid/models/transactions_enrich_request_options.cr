...
module Plaid
  ...
  class TransactionsEnrichRequestOptions
    ...
    @[JSON::Field(key: "include_legacy_category", type: Bool?, default: false, required: false, nullable: false, emit_null: false)]
    getter include_legacy_category : Bool? = false
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_include_legacy_category = @include_legacy_category).nil?
      end
      invalid_properties
    end
    ...
    # @param [Object] include_legacy_category Object to be assigned
    def include_legacy_category=(new_value : Bool?)
      unless new_value.nil?
      end

      @include_legacy_category = new_value
    end
    ...
    def_equals_and_hash(@include_legacy_category)
  end
end
