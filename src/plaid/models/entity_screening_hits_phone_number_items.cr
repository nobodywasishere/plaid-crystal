...
require "./entity_screening_hit_phone_numbers"
...
module Plaid
  ...
  class EntityScreeningHitsPhoneNumberItems
    ...
    @[JSON::Field(key: "data", type: EntityScreeningHitPhoneNumbers?, default: nil, required: false, nullable: false, emit_null: false)]
    getter data : EntityScreeningHitPhoneNumbers? = nil
    ...
    def initialize(
      *,
      ...
      @data : EntityScreeningHitPhoneNumbers? = nil
    )
    end
    ...
    def data=(new_value : EntityScreeningHitPhoneNumbers?)
      unless new_value.nil?
      end
