...
module Plaid
  class RiskCheckLinkedService
    ...
    def self.from_json(value : JSON::PullParser) : RiskCheckLinkedService
      new(value)
    end

    def self.to_json(value : RiskCheckLinkedService, json : JSON::Builder) : Nil
      value.to_json(json)
    end
    ...
    def validate : Nil
      OpenApi::EnumValidator.validate("RiskCheckLinkedService", data, VALID_VALUES, false)
    end
