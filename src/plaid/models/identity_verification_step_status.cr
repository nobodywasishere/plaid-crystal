...
module Plaid
  class IdentityVerificationStepStatus
    ...
    def self.from_json(value : JSON::PullParser) : IdentityVerificationStepStatus
      new(value)
    end

    def self.to_json(value : IdentityVerificationStepStatus, json : JSON::Builder) : Nil
      value.to_json(json)
    end
    ...
    def validate : Nil
      OpenApi::EnumValidator.validate("IdentityVerificationStepStatus", data, VALID_VALUES, false)
    end
