...
require "./asset_report_pdf_get_request_options"
...
module Plaid
  ...
  class AssetReportPDFGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::AssetReportPDFGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::AssetReportPDFGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::AssetReportPDFGetRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::AssetReportPDFGetRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@asset_report_token, @client_id, @secret, @options)
  end
end
