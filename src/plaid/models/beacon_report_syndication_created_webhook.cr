...
module Plaid
  ...
  class BeaconReportSyndicationCreatedWebhook
    ...
    @[JSON::Field(key: "beacon_report_syndication_id", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    getter beacon_report_syndication_id : String? = nil
    ...
    def initialize(
      *,
      ...
      @beacon_report_syndication_id : String? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"beacon_report_syndication_id\" is required and cannot be null") if @beacon_report_syndication_id.nil?

      unless (_beacon_report_syndication_id = @beacon_report_syndication_id).nil?
      end
    ...
    def valid? : Bool
      ...
      return false if @beacon_report_syndication_id.nil?
      unless (_beacon_report_syndication_id = @beacon_report_syndication_id).nil?
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] beacon_report_syndication_id Object to be assigned
    def beacon_report_syndication_id=(new_value : String?)
      raise ArgumentError.new("\"beacon_report_syndication_id\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @beacon_report_syndication_id = new_value
    end
    ...
    def_equals_and_hash(@webhook_type, @webhook_code, @beacon_report_syndication_id, @environment)
  end
end
