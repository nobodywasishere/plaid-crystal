...
module Plaid
  ...
  class BankIncomeRefreshCompleteWebhook
    ...
    @[JSON::Field(key: "result", type: Plaid::BankIncomeRefreshCompleteResult?, default: nil, required: true, nullable: false, emit_null: false)]
    getter result : Plaid::BankIncomeRefreshCompleteResult? = nil
    ...
    def initialize(
      *,
      ...
      @user_id : String? = nil,
      @result : Plaid::BankIncomeRefreshCompleteResult? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_result = @result).nil?
        invalid_properties.push(_result.error_message) if !_result.valid?
      end
    ...
    def result=(new_value : Plaid::BankIncomeRefreshCompleteResult?)
    ...
    def_equals_and_hash(@webhook_type, @webhook_code, @user_id, @result, @environment)
  end
end
