...
require "./beacon_user_request_address"
...
module Plaid
  ...
  class BeaconUserRequestData
    ...
    @[JSON::Field(key: "address", type: BeaconUserRequestAddress?, default: nil, required: true, nullable: false, emit_null: false)]
    getter address : BeaconUserRequestAddress? = nil
    ...
    @[JSON::Field(key: "id_number", type: BeaconUserIDNumber?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def initialize(
      *,
      ...
      @address : BeaconUserRequestAddress? = nil,
      # Optional properties
    ...
    def address=(new_value : BeaconUserRequestAddress?)
    ...
    def_equals_and_hash(@date_of_birth, @name, @address, @email_address, @phone_number, @phone_number_present, @id_number, @ip_address, @ip_address_present)
  end
end
