...
require "./income_verification_create_request_options"
...
module Plaid
  ...
  class IncomeVerificationCreateRequest
    ...
    @[JSON::Field(key: "precheck_id", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    getter precheck_id : String? = nil

    @[JSON::Field(key: "options", type: Plaid::IncomeVerificationCreateRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::IncomeVerificationCreateRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @options : Plaid::IncomeVerificationCreateRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::IncomeVerificationCreateRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@webhook, @client_id, @secret, @precheck_id, @options)
  end
end
