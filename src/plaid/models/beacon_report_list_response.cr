...
require "./beacon_report"

module Plaid
  # The response schema for `/beacon/report/list`
  class BeaconReportListResponse
    ...
    @[JSON::Field(key: "beacon_reports", type: Array(BeaconReport)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter beacon_reports : Array(BeaconReport)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @beacon_reports : Array(BeaconReport)? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"beacon_reports\" is required and cannot be null") if @beacon_reports.nil?

      unless (_beacon_reports = @beacon_reports).nil?
      end
    ...
    def valid? : Bool
      return false if @beacon_reports.nil?
      unless (_beacon_reports = @beacon_reports).nil?
      end
    ...
    # @param [Object] beacon_reports Object to be assigned
    def beacon_reports=(new_value : Array(BeaconReport)?)
      raise ArgumentError.new("\"beacon_reports\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @beacon_reports = new_value
    end
    ...
    def_equals_and_hash(@beacon_reports, @next_cursor, @request_id)
  end
end
