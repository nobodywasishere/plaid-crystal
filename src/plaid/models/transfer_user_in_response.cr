...
require "./transfer_user_address_in_response"
...
module Plaid
  ...
  class TransferUserInResponse
    ...
    @[JSON::Field(key: "address", type: TransferUserAddressInResponse?, default: nil, required: true, nullable: true, emit_null: true)]
    getter address : TransferUserAddressInResponse? = nil
    ...
    def initialize(
      *,
      ...
      @address : TransferUserAddressInResponse? = nil
    )
    end
    ...
    def address=(new_value : TransferUserAddressInResponse?)
      unless new_value.nil?
      end
