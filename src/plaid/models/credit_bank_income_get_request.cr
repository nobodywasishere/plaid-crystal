...
require "./credit_bank_income_get_request_options"
...
module Plaid
  ...
  class CreditBankIncomeGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::CreditBankIncomeGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::CreditBankIncomeGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @options : Plaid::CreditBankIncomeGetRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::CreditBankIncomeGetRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@client_id, @secret, @user_token, @options)
  end
end
