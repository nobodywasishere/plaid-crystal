...
module Plaid
  ...
  class AddressDataNotRequired
    ...
    def_equals_and_hash(@city, @city_present, @region, @region_present, @street, @postal_code, @postal_code_present, @country, @country_present)
  end
end
