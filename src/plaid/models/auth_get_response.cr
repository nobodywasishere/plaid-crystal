...
module Plaid
  ...
  class AuthGetResponse
    ...
    @[JSON::Field(key: "numbers", type: AuthGetNumbers?, default: nil, required: true, nullable: false, emit_null: false)]
    getter numbers : AuthGetNumbers? = nil
    ...
    def numbers=(new_value : AuthGetNumbers?)
    ...
    def_equals_and_hash(@accounts, @numbers, @item, @request_id)
  end
end
