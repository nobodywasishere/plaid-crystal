...
module Plaid
  class Products
    ...
    def self.from_json(value : JSON::PullParser) : Products
      new(value)
    end

    def self.to_json(value : Products, json : JSON::Builder) : Nil
      value.to_json(json)
    end
    ...
    def validate : Nil
      OpenApi::EnumValidator.validate("Products", data, VALID_VALUES, false)
    end
