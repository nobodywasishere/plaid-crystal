...
module Plaid
  ...
  class EntityWatchlistScreeningSearchTerms
    ...
    @[JSON::Field(key: "document_number", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def_equals_and_hash(@entity_watchlist_program_id, @legal_name, @document_number, @email_address, @country, @phone_number, @url, @version)
  end
end
