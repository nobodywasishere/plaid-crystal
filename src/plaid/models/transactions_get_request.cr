...
require "./transactions_get_request_options"
...
module Plaid
  ...
  class TransactionsGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::TransactionsGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::TransactionsGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @options : Plaid::TransactionsGetRequestOptions? = nil,
      @secret : String? = nil
    )
    end
    ...
    def options=(new_value : Plaid::TransactionsGetRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@access_token, @start_date, @end_date, @client_id, @options, @secret)
  end
end
