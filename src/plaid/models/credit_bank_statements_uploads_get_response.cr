...
require "./credit_bank_statement_upload_item"
...
module Plaid
  ...
  class CreditBankStatementsUploadsGetResponse
    ...
    @[JSON::Field(key: "items", type: Array(Plaid::CreditBankStatementUploadItem)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter items : Array(Plaid::CreditBankStatementUploadItem)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @items : Array(Plaid::CreditBankStatementUploadItem)? = nil,
    ...
    def items=(new_value : Array(Plaid::CreditBankStatementUploadItem)?)
    ...
    def_equals_and_hash(@items, @request_id)
  end
end
