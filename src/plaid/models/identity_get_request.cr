...
require "./identity_get_request_options"
...
module Plaid
  ...
  class IdentityGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::IdentityGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::IdentityGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::IdentityGetRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::IdentityGetRequestOptions?)
      unless new_value.nil?
