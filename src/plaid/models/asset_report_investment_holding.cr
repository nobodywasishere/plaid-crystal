...
module Plaid
  ...
  class AssetReportInvestmentHolding
    ...
    def_equals_and_hash(@account_id, @security_id, @ticker_symbol, @institution_price, @institution_value, @cost_basis, @quantity, @iso_currency_code, @unofficial_currency_code, @institution_price_as_of, @institution_price_as_of_present)
  end
end
