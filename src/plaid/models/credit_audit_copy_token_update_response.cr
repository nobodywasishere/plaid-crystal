...
module Plaid
  ...
  class CreditAuditCopyTokenUpdateResponse
    ...
    @[JSON::Field(key: "updated", type: Bool?, default: nil, required: true, nullable: false, emit_null: false)]
    getter updated : Bool? = nil
    ...
    def_equals_and_hash(@request_id, @updated)
  end
end
