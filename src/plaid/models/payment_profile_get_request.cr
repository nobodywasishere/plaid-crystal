...
module Plaid
  ...
  class PaymentProfileGetRequest
    ...
    @[JSON::Field(key: "payment_profile_token", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"payment_profile_token\" is required and cannot be null") if @payment_profile_token.nil?
    ...
    def valid? : Bool
      return false if @payment_profile_token.nil?
      unless (_payment_profile_token = @payment_profile_token).nil?
      end
    ...
    def payment_profile_token=(new_value : String?)
      raise ArgumentError.new("\"payment_profile_token\" is required and cannot be null") if new_value.nil?
    ...
    def_equals_and_hash(@payment_profile_token, @client_id, @secret)
  end
end
