...
require "./payment_initiation_payment_create_status"
...
module Plaid
  ...
  class PaymentInitiationPaymentCreateResponse
    ...
    @[JSON::Field(key: "status", type: Plaid::PaymentInitiationPaymentCreateStatus?, default: nil, required: true, nullable: false, emit_null: false)]
    getter status : Plaid::PaymentInitiationPaymentCreateStatus? = nil
    ...
    def initialize(
      *,
      ...
      @status : Plaid::PaymentInitiationPaymentCreateStatus? = nil,
    ...
    def status=(new_value : Plaid::PaymentInitiationPaymentCreateStatus?)
