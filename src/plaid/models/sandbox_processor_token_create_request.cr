...
require "./sandbox_processor_token_create_request_options"
...
module Plaid
  ...
  class SandboxProcessorTokenCreateRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::SandboxProcessorTokenCreateRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::SandboxProcessorTokenCreateRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::SandboxProcessorTokenCreateRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::SandboxProcessorTokenCreateRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@institution_id, @client_id, @secret, @options)
  end
end
