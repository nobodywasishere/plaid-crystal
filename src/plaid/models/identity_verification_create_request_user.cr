...
module Plaid
  ...
  class IdentityVerificationCreateRequestUser
    ...
    def_equals_and_hash(@email_address, @phone_number, @phone_number_present, @date_of_birth, @name, @name_present, @address, @address_present, @id_number, @id_number_present, @client_user_id, @client_user_id_present)
  end
end
