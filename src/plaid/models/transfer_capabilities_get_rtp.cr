...
module Plaid
  ...
  class TransferCapabilitiesGetRTP
    ...
    @[JSON::Field(key: "credit", type: Bool?, default: false, required: false, nullable: false, emit_null: false)]
    getter credit : Bool? = false
