...
module Plaid
  ...
  class EntityScreeningHitPhoneNumbers
    ...
    @[JSON::Field(key: "type", type: Plaid::PhoneType?, default: nil, required: true, nullable: false, emit_null: false)]
    getter _type : Plaid::PhoneType? = nil

    # A phone number in E.164 format.
    @[JSON::Field(key: "phone_number", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    def _type=(new_value : Plaid::PhoneType?)
    ...
    def_equals_and_hash(@_type, @phone_number)
  end
end
