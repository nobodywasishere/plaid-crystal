...
module Plaid
  ...
  class ProcessorAuthGetResponse
    ...
    @[JSON::Field(key: "numbers", type: ProcessorNumber?, default: nil, required: true, nullable: false, emit_null: false)]
    getter numbers : ProcessorNumber? = nil
    ...
    def numbers=(new_value : ProcessorNumber?)
    ...
    def_equals_and_hash(@request_id, @numbers, @account)
  end
end
