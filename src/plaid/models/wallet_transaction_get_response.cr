...
module Plaid
  ...
  class WalletTransactionGetResponse
    ...
    def_equals_and_hash(@transaction_id, @wallet_id, @reference, @_type, @amount, @counterparty, @status, @created_at, @last_status_update, @request_id, @scheme, @scheme_present, @payment_id, @payment_id_present, @failure_reason, @failure_reason_present)
  end
end
