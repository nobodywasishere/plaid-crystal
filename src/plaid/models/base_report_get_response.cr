...
module Plaid
  ...
  class BaseReportGetResponse
    ...
    @[JSON::Field(key: "report", type: BaseReport?, default: nil, required: true, nullable: false, emit_null: false)]
    getter report : BaseReport? = nil
    ...
    @[JSON::Field(key: "warnings", type: Array(BaseReportWarning)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter warnings : Array(BaseReportWarning)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @report : BaseReport? = nil,
      @request_id : String? = nil,
      # Optional properties
      @warnings : Array(BaseReportWarning)? = nil
    )
    end
    ...
    def report=(new_value : BaseReport?)
    ...
    def warnings=(new_value : Array(BaseReportWarning)?)
      unless new_value.nil?
      end
    ...
    def_equals_and_hash(@report, @request_id, @warnings)
  end
end
