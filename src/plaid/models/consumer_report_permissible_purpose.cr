...
module Plaid
  class ConsumerReportPermissiblePurpose
    ...
    def self.from_json(value : JSON::PullParser) : ConsumerReportPermissiblePurpose
      new(value)
    end

    def self.to_json(value : ConsumerReportPermissiblePurpose, json : JSON::Builder) : Nil
      value.to_json(json)
    end
    ...
    def validate : Nil
      OpenApi::EnumValidator.validate("ConsumerReportPermissiblePurpose", data, VALID_VALUES, false)
    end
