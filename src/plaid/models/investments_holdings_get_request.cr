...
require "./investment_holdings_get_request_options"
...
module Plaid
  ...
  class InvestmentsHoldingsGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::InvestmentHoldingsGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::InvestmentHoldingsGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::InvestmentHoldingsGetRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::InvestmentHoldingsGetRequestOptions?)
      unless new_value.nil?
