...
module Plaid
  ...
  class TransferRecurringListRequest
    ...
    @[JSON::Field(key: "start_time", type: Time?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: start_time.nil? && !start_time_present?, converter: Time::RFC3339Converter)]
    ...
    @[JSON::Field(key: "end_time", type: Time?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: end_time.nil? && !end_time_present?, converter: Time::RFC3339Converter)]
    ...
    def_equals_and_hash(@client_id, @secret, @start_time, @start_time_present, @end_time, @end_time_present, @count, @offset, @funding_account_id, @funding_account_id_present)
  end
end
