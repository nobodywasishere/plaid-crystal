...
module Plaid
  ...
  class Email
    ...
    ERROR_MESSAGE_FOR__TYPE = "invalid value for \"_type\", must be one of [primary, secondary, other]."
    VALID_VALUES_FOR__TYPE  = String.static_array("primary", "secondary", "other")
