...
module Plaid
  ...
  class SandboxPaymentProfileResetLoginResponse
    ...
    @[JSON::Field(key: "reset_login", type: Bool?, default: nil, required: true, nullable: false, emit_null: false)]
    getter reset_login : Bool? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"reset_login\" is required and cannot be null") if @reset_login.nil?

      unless (_reset_login = @reset_login).nil?
      end
    ...
    def valid? : Bool
      return false if @reset_login.nil?
      unless (_reset_login = @reset_login).nil?
      end
    ...
    # @param [Object] reset_login Object to be assigned
    def reset_login=(new_value : Bool?)
      raise ArgumentError.new("\"reset_login\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @reset_login = new_value
    end
    ...
    def_equals_and_hash(@reset_login, @request_id)
  end
end
