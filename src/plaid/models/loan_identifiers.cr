...
module Plaid
  ...
  class LoanIdentifiers
    ...
    @[JSON::Field(key: "LOAN_IDENTIFIER", type: LoanIdentifier?, default: nil, required: true, nullable: false, emit_null: false)]
    getter loan_identifier : LoanIdentifier? = nil
    ...
    def initialize(
      *,
      # Required properties
      @loan_identifier : LoanIdentifier? = nil
    )
    end
    ...
    def loan_identifier=(new_value : LoanIdentifier?)
