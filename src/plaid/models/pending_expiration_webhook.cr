...
module Plaid
  ...
  class PendingExpirationWebhook
    ...
    @[JSON::Field(key: "consent_expiration_time", type: Time?, default: nil, required: true, nullable: false, emit_null: false, converter: Time::RFC3339Converter)]
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"consent_expiration_time\" is required and cannot be null") if @consent_expiration_time.nil?
    ...
    def valid? : Bool
      ...
      return false if @consent_expiration_time.nil?
      unless (_consent_expiration_time = @consent_expiration_time).nil?
      end
    ...
    def consent_expiration_time=(new_value : Time?)
      raise ArgumentError.new("\"consent_expiration_time\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end
    ...
    def_equals_and_hash(@webhook_type, @webhook_code, @item_id, @consent_expiration_time, @environment)
  end
end
