...
module Plaid
  ...
  class EntityScreeningHitDocumentsItems
    ...
    @[JSON::Field(key: "data", type: EntityDocument?, default: nil, required: false, nullable: false, emit_null: false)]
    getter data : EntityDocument? = nil
    ...
    def data=(new_value : EntityDocument?)
      unless new_value.nil?
      end
