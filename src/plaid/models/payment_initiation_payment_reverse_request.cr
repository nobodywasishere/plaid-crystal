...
require "./payment_amount_to_refund"
...
module Plaid
  ...
  class PaymentInitiationPaymentReverseRequest
    ...
    @[JSON::Field(key: "amount", type: Plaid::PaymentAmountToRefund?, default: nil, required: false, nullable: false, emit_null: false)]
    getter amount : Plaid::PaymentAmountToRefund? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @amount : Plaid::PaymentAmountToRefund? = nil
    )
    end
    ...
    def amount=(new_value : Plaid::PaymentAmountToRefund?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@payment_id, @idempotency_key, @reference, @client_id, @secret, @amount)
  end
end
