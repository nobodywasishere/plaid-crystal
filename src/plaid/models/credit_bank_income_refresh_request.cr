...
require "./credit_bank_income_refresh_request_options"
...
module Plaid
  ...
  class CreditBankIncomeRefreshRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::CreditBankIncomeRefreshRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::CreditBankIncomeRefreshRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::CreditBankIncomeRefreshRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::CreditBankIncomeRefreshRequestOptions?)
      unless new_value.nil?
