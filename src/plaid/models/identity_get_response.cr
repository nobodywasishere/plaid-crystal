...
module Plaid
  ...
  class IdentityGetResponse
    ...
    @[JSON::Field(key: "accounts", type: Array(Plaid::AccountIdentity)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter accounts : Array(Plaid::AccountIdentity)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @accounts : Array(Plaid::AccountIdentity)? = nil,
      @item : Item? = nil,
    ...
    def accounts=(new_value : Array(Plaid::AccountIdentity)?)
