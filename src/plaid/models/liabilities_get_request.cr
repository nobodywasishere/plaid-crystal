...
require "./liabilities_get_request_options"
...
module Plaid
  ...
  class LiabilitiesGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::LiabilitiesGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::LiabilitiesGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::LiabilitiesGetRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::LiabilitiesGetRequestOptions?)
      unless new_value.nil?
