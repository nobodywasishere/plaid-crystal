...
module Plaid
  ...
  class ProcessorIdentityGetResponse
    ...
    @[JSON::Field(key: "account", type: Plaid::AccountIdentity?, default: nil, required: true, nullable: false, emit_null: false)]
    getter account : Plaid::AccountIdentity? = nil
    ...
    def initialize(
      *,
      # Required properties
      @account : Plaid::AccountIdentity? = nil,
    ...
    def account=(new_value : Plaid::AccountIdentity?)
