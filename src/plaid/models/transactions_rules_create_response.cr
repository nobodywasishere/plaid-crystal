...
module Plaid
  ...
  class TransactionsRulesCreateResponse
    ...
    @[JSON::Field(key: "rule", type: Plaid::TransactionsCategoryRule?, default: nil, required: true, nullable: false, emit_null: false)]
    getter rule : Plaid::TransactionsCategoryRule? = nil
    ...
    def initialize(
      *,
      # Required properties
      @rule : Plaid::TransactionsCategoryRule? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"rule\" is required and cannot be null") if @rule.nil?
    ...
    def rule=(new_value : Plaid::TransactionsCategoryRule?)
      raise ArgumentError.new("\"rule\" is required and cannot be null") if new_value.nil?
    ...
    def_equals_and_hash(@rule, @request_id)
  end
end
