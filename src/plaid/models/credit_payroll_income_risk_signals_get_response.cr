...
require "./payroll_risk_signals_item"
require "./plaid_error"
...
module Plaid
  ...
  class CreditPayrollIncomeRiskSignalsGetResponse
    ...
    @[JSON::Field(key: "items", type: Array(PayrollRiskSignalsItem)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter items : Array(PayrollRiskSignalsItem)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @items : Array(PayrollRiskSignalsItem)? = nil,
    ...
    def items=(new_value : Array(PayrollRiskSignalsItem)?)
