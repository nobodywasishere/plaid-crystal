...
module Plaid
  ...
  class InstitutionsGetByIdResponse
    ...
    @[JSON::Field(key: "institution", type: Institution?, default: nil, required: true, nullable: false, emit_null: false)]
    getter institution : Institution? = nil
    ...
    def institution=(new_value : Institution?)
    ...
    def_equals_and_hash(@institution, @request_id)
  end
end
