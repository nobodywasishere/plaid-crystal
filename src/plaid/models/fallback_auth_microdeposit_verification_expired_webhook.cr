...
module Plaid
  ...
  class FallbackAuthMicrodepositVerificationExpiredWebhook
    ...
    def_equals_and_hash(@webhook_type, @webhook_code, @account_id, @item_id, @environment, @error, @error_present)
  end
end
