...
require "./accounts_balance_get_request_options"
...
module Plaid
  ...
  class AccountsBalanceGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::AccountsBalanceGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::AccountsBalanceGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @options : Plaid::AccountsBalanceGetRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::AccountsBalanceGetRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@access_token, @secret, @client_id, @options)
  end
end
