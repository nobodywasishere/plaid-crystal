...
require "./investments_auth_get_request_options"
...
module Plaid
  ...
  class InvestmentsAuthGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::InvestmentsAuthGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::InvestmentsAuthGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::InvestmentsAuthGetRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::InvestmentsAuthGetRequestOptions?)
      unless new_value.nil?
