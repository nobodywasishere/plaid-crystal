...
require "./bank_income_complete_result"
...
module Plaid
  ...
  class BankIncomeCompleteWebhook
    ...
    @[JSON::Field(key: "result", type: Plaid::BankIncomeCompleteResult?, default: nil, required: true, nullable: false, emit_null: false)]
    getter result : Plaid::BankIncomeCompleteResult? = nil
    ...
    def initialize(
      *,
      ...
      @user_id : String? = nil,
      @result : Plaid::BankIncomeCompleteResult? = nil,
    ...
    def result=(new_value : Plaid::BankIncomeCompleteResult?)
