...
module Plaid
  ...
  class TransferQuestionnaireCreateResponse
    ...
    @[JSON::Field(key: "onboarding_url", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    getter onboarding_url : String? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"onboarding_url\" is required and cannot be null") if @onboarding_url.nil?

      unless (_onboarding_url = @onboarding_url).nil?
      end
    ...
    def valid? : Bool
      return false if @onboarding_url.nil?
      unless (_onboarding_url = @onboarding_url).nil?
      end
    ...
    # @param [Object] onboarding_url Object to be assigned
    def onboarding_url=(new_value : String?)
      raise ArgumentError.new("\"onboarding_url\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @onboarding_url = new_value
    end
    ...
    def_equals_and_hash(@onboarding_url, @request_id)
  end
end
