...
require "./asset_report_investments"
require "./asset_report_transaction"
...
module Plaid
  ...
  class AccountAssets
    ...
    @[JSON::Field(key: "transactions", type: Array(AssetReportTransaction)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter transactions : Array(AssetReportTransaction)? = nil
    ...
    @[JSON::Field(key: "investments", type: AssetReportInvestments?, default: nil, required: false, nullable: false, emit_null: false)]
    getter investments : AssetReportInvestments? = nil

    @[JSON::Field(key: "ownership_type", type: Plaid::OwnershipType?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: ownership_type.nil? && !ownership_type_present?)]
    getter ownership_type : Plaid::OwnershipType? = nil

    @[JSON::Field(ignore: true)]
    property? ownership_type_present : Bool = false
    ...
    def initialize(
      *,
      ...
      @transactions : Array(AssetReportTransaction)? = nil,
      ...
      @investments : AssetReportInvestments? = nil,
    ...
    def transactions=(new_value : Array(AssetReportTransaction)?)
    ...
    def investments=(new_value : AssetReportInvestments?)
      unless new_value.nil?
      end
    ...
    def_equals_and_hash(@account_id, @balances, @mask, @name, @official_name, @_type, @subtype, @days_available, @transactions, @owners, @historical_balances, @verification_status, @persistent_account_id, @investments, @ownership_type, @ownership_type_present)
  end
end
