...
require "./identity_match_request_options"
require "./identity_match_user"
...
module Plaid
  ...
  class IdentityMatchRequest
    ...
    @[JSON::Field(key: "user", type: IdentityMatchUser?, default: nil, required: false, nullable: false, emit_null: false)]
    getter user : IdentityMatchUser? = nil

    @[JSON::Field(key: "options", type: Plaid::IdentityMatchRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::IdentityMatchRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @user : IdentityMatchUser? = nil,
      @options : Plaid::IdentityMatchRequestOptions? = nil
    )
    end
    ...
    def user=(new_value : IdentityMatchUser?)
      unless new_value.nil?
      end
    ...
    def options=(new_value : Plaid::IdentityMatchRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@access_token, @client_id, @secret, @user, @options)
  end
end
