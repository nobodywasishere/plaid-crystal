...
module Plaid
  ...
  class IdentityVerificationListResponse
    ...
    @[JSON::Field(key: "identity_verifications", type: Array(IdentityVerification)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter identity_verifications : Array(IdentityVerification)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @identity_verifications : Array(IdentityVerification)? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"identity_verifications\" is required and cannot be null") if @identity_verifications.nil?

      unless (_identity_verifications = @identity_verifications).nil?
      end
    ...
    def valid? : Bool
      return false if @identity_verifications.nil?
      unless (_identity_verifications = @identity_verifications).nil?
      end
    ...
    # @param [Object] identity_verifications Object to be assigned
    def identity_verifications=(new_value : Array(IdentityVerification)?)
      raise ArgumentError.new("\"identity_verifications\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @identity_verifications = new_value
    end
    ...
    def_equals_and_hash(@identity_verifications, @next_cursor, @request_id)
  end
end
