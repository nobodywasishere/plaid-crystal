...
module Plaid
  ...
  class TransferAuthorizationDecisionRationale
    ...
    @[JSON::Field(key: "code", type: Plaid::TransferAuthorizationDecisionRationaleCode?, default: nil, required: true, nullable: false, emit_null: false)]
    getter code : Plaid::TransferAuthorizationDecisionRationaleCode? = nil
    ...
    def initialize(
      *,
      # Required properties
      @code : Plaid::TransferAuthorizationDecisionRationaleCode? = nil,
    ...
    def code=(new_value : Plaid::TransferAuthorizationDecisionRationaleCode?)
