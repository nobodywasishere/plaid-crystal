...
module Plaid
  ...
  class DeductionsBreakdown
    ...
    def_equals_and_hash(@current_amount, @current_amount_present, @description, @description_present, @iso_currency_code, @iso_currency_code_present, @unofficial_currency_code, @unofficial_currency_code_present, @ytd_amount, @ytd_amount_present)
  end
end
