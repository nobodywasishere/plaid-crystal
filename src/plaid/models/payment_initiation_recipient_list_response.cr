...
require "./payment_initiation_recipient"
...
module Plaid
  ...
  class PaymentInitiationRecipientListResponse
    ...
    @[JSON::Field(key: "recipients", type: Array(PaymentInitiationRecipient)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter recipients : Array(PaymentInitiationRecipient)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @recipients : Array(PaymentInitiationRecipient)? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"recipients\" is required and cannot be null") if @recipients.nil?

      unless (_recipients = @recipients).nil?
      end
    ...
    def recipients=(new_value : Array(PaymentInitiationRecipient)?)
      raise ArgumentError.new("\"recipients\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
      end

      @recipients = new_value
    end
    ...
    def_equals_and_hash(@recipients, @request_id)
  end
end
