...
require "./transactions_recurring_get_request_options"
...
module Plaid
  ...
  class TransactionsRecurringGetRequest
    ...
    @[JSON::Field(key: "options", type: Plaid::TransactionsRecurringGetRequestOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter options : Plaid::TransactionsRecurringGetRequestOptions? = nil
    ...
    def initialize(
      *,
      ...
      @secret : String? = nil,
      @options : Plaid::TransactionsRecurringGetRequestOptions? = nil
    )
    end
    ...
    def options=(new_value : Plaid::TransactionsRecurringGetRequestOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@access_token, @account_ids, @client_id, @secret, @options)
  end
end
