...
require "./credit_freddie_mac_verification_of_assets_deal"
...
module Plaid
  ...
  class CreditFreddieMacReportsGetResponse
    ...
    @[JSON::Field(key: "DEAL", type: CreditFreddieMacVerificationOfAssetsDeal?, default: nil, required: true, nullable: false, emit_null: false)]
    getter deal : CreditFreddieMacVerificationOfAssetsDeal? = nil
    ...
    def initialize(
      *,
      # Required properties
      @deal : CreditFreddieMacVerificationOfAssetsDeal? = nil,
    ...
    def deal=(new_value : CreditFreddieMacVerificationOfAssetsDeal?)
