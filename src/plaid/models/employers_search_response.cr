...
module Plaid
  ...
  class EmployersSearchResponse
    ...
    @[JSON::Field(key: "employers", type: Array(Employer)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter employers : Array(Employer)? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"employers\" is required and cannot be null") if @employers.nil?

      unless (_employers = @employers).nil?
      end
    ...
    # @param [Object] employers Object to be assigned
    def employers=(new_value : Array(Employer)?)
      raise ArgumentError.new("\"employers\" is required and cannot be null") if new_value.nil?
    ...
    def_equals_and_hash(@employers, @request_id)
  end
end
