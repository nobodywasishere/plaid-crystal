...
require "./credit_session_bank_employment_status"
...
module Plaid
  ...
  class CreditSessionBankEmploymentResult
    ...
    @[JSON::Field(key: "status", type: Plaid::CreditSessionBankEmploymentStatus?, default: nil, required: false, nullable: false, emit_null: false)]
    getter status : Plaid::CreditSessionBankEmploymentStatus? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @status : Plaid::CreditSessionBankEmploymentStatus? = nil,
      @item_id : String? = nil,
    ...
    def status=(new_value : Plaid::CreditSessionBankEmploymentStatus?)
